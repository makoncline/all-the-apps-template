...
const HomePage = () => (
  <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-10 px-6 py-12">
    <section className="space-y-4">
      <p className="inline-flex rounded-full border border-ink/10 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-ink/60">
        Hello Monorepo
      </p>
    ...
    <section className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <p className="text-sm text-ink/60">Newest first</p>
      </div>
      <GreetingList />
    </section>
  </main>
